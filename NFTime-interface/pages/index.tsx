          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6} md={4} lg={3}>
              ...
              >
                ...
                >
                  You can mint new NFTs easily with for free with NFTime
                </Typography>
              </Stack>
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
              ...
              >
                ...
                <Typography
                  ...
                  color="text.secondary"
                >
                  NFTime has 0% fees on buying, selling, listing or withdrawing
                  money
                </Typography>
              </Stack>
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
              ...
              >
                ...
                <Typography
                  ...
                  color="text.secondary"
                >
                  NFTime works on sepolia testnet, so you can test it without
                  paying
                </Typography>
              </Stack>
            </Grid>
