...
import { convertHttpToIpfs, formatTxErrors } from "@/src/utils/format";
...
const UserNFTsCard = ({
  ...
  /**
   * Give NFTime the access to the NFT the user wants to list
   */
      ...
      await fetch({
        ...
        onSuccess: async (tx: any) => {
          await toast.promise(tx.wait(1), {
            ...
            success: "NFTime has the access now",
        ...
        onError: (err: any) => {
          ...
          // We didint took this error in considations, as the operator is always NFTime contract address
  ...
  /**
   * Check if the NFTime has access to this NFT.
    ...
    <>
      <Paper sx={{ p: 2 }} elevation={5}>
        <Box>
          <Image
            src={
              imageError ? placeholderImage : convertHttpToIpfs(imageUrl)
            }
      ...
      >
        ...
        <DialogContent sx={{ p: 2 }}>
          ...
          <Stack direction="column" spacing={1}>
            ...
            <Stack direction="row" justifyContent="space-between">
              <Typography>NFTime feees</Typography>
      ...
      >
        ...
        >
          <DialogTitle id="alert-approve-dialog-title" sx={{ p: 0 }}>
            {"NFTime Accessibility to the NFT"}
          </DialogTitle>
